...
<div className='wrap'>
    ...
    <div className="box box-left">
        ...
        <p>
        At  Buena Park Rehab Center, we provide several other avenues of addiction treatment. In addition to our partial hospitalization program, we offer:</p>
        <br />
        <ul>
            <li><p>Partial Hospitalization Program - IOP</p></li>
            <li><p>Intensive Outpatient Program - OP</p></li>
