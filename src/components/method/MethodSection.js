  ...
  return (
    <>
      ...
      <div className="container treatment-section-overview">
        ...
        <p>
          Here at Buena Park Rehab, we firmly stand that without addressing our
          ...
          <br />
          <br />
          Methods used by Buena Park Rehab are non-invasive, distinct, and
      ...
      <div className="treatment-section-activities">
        <div className="treatment-left">
          ...
          <p>
            Buena Park Rehab promotes fun activities that clients learn how to
